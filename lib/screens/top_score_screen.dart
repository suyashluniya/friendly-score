...
class SmoothWheelScrollPhysics extends FixedExtentScrollPhysics {
  const SmoothWheelScrollPhysics({super.parent});

  @override
  SmoothWheelScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return SmoothWheelScrollPhysics(parent: buildParent(ancestor));
  }
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Top score mode: Maximum time is double the time allowed.',
                                    style: GoogleFonts.poppins(
                                      color: AppColors.textSecondary,
                                      fontSize: 12,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Scroll to set hours, minutes, and seconds. Maximum time will be double.',
                      style: GoogleFonts.poppins(
                        fontSize: 14,
                        color: AppColors.textSecondary,
                      ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'In Top Score mode, the maximum time is double the time allowed you set.',
                              style: GoogleFonts.poppins(
                                color: AppColors.textSecondary,
                                fontSize: 13,
          ...
          child: Stack(
            children: [
              ...
              ListWheelScrollView.useDelegate(
                ...
                diameterRatio: 1.5,
                perspective: 0.004,
                physics: const SmoothWheelScrollPhysics(),
